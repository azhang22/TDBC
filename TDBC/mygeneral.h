...
struct PoreStruct{
	...
	double porosity;
	double resistivity;//mks.Rayls/m(or Pa.s/m2),static flow resistivity 
	double Kp;//m.s2/kg
	double tau;//characteristic relaxation time
	double Z_inf;//characteristic impedance
};
...
enum boundary_type{rigid,absorbing,porous_media,TDBC};
