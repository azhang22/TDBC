...
{
	protected:
		double eff_density,porosity,resistivity,Kp;//kg/m3;mks.Rayls/m(or Pa.s/m2),m.s2/kg
		double Beta,Gama;
	public:
		porous(){};
		porous(scheme_list,DifferenceStep,char *coordi,MovingFrame MF,const double,PoreStruct PorePara,
				AirStruct AirPara,vortex vortex1,int mpi_rank1,int mpi_size1,int mpi_yarea1,int mpi_zarea1,int mpi_porous1);
		~porous();
